...
const mongoose = require("mongoose"); // level 5
...
// const md5 = require("md5"); // hashing, level 4
// const bcrypt = require('bcrypt'); // salting & hashing level 4
// const saltRounds = 10;
// const encrypt = require("mongoose-encryption"); // encryption level 2
...
// userSchema.plugin(encrypt, { secret: process.env.SECRET, encryptedFields: ['password'] }); // process.env.SECRET level 3
...
app.get('/auth/facebook/secrets',
  passport.authenticate('facebook', { scope: ['profile'], failureRedirect: '/login' }),
  function(req, res) {
    res.redirect('/secrets');
  }
);
